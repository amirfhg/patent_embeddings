...
\]$$. We then prompt LLMs to read, identify, and retrieve the name and description of technological domains that receive the most attention according to $\Delta_{12-60}$.
